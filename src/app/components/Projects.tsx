        ...
        <section id="projects" className="space-y-4 ">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <Project
                    ...
                    description="A digital platform that allows users to express themselves freely and anonymously, similar to a classic freedom wall. "
                    tags={["React"]}
                />
                ...
                <Project
                    ...
                    description={
                        <>
                            A command-line tool for generating <i>.gitignore</i>{" "}
                            files from language templates provided by{" "}
                            <code>github/gitignore</code>.
                        </>
                    }
                    tags={["Golang"]}
                />
                ...
                <Project
                    ...
                    description={
                        <>
                            A web application created for{" "}
                            <B>Bulacan State University</B> to help instructors
                            plot and visualize their schedules.
                        </>
                    }
                    tags={["React", "NextJS"]}
                />
                ...
                <Project
                    ...
                    description={
                        <>
                            A realtime chat web application for learning
                            WebSockets.
                        </>
                    }
                    tags={["Solid", "Golang"]}
                ...
                <Project
                    ...
                    description={
                        <>
                            ...
                            integrated with <B>Artificial Intelligence</B> and
                            other utility tools.
                        </>
                    }
                ...
                <Project
                    ...
                    description={
                        <>
                            A stunning website that empowers you to upload,
                            share, and secure images with ease.
                        </>
                    }
