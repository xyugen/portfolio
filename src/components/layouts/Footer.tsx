...
const Footer = () => {
    return (
        <footer className="bg-background border-t border-t-muted p-8 xl:px-20 z-50">
            <div className="flex flex-col flex-wrap md:flex-row items-start md:items-end justify-between">
